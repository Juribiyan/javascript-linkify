...
/*!
 * Adapted for multiple environments such as Node by Snivy, 2015
 * https://github.com/Juribiyan/javascript-linkify
 * using code from lodash (https://lodash.com/)
...
;(function() {
  ...
  /* -------------------- Universal exporting from Lodash -------------------- */
  ...
  // Check for `exports` after `define` in case a build optimizer adds an `exports` object.
    ...
    if (moduleExports) {
      (freeModule.exports = linkify).linkify = linkify;
    }
    // Export for Narwhal or Rhino -require.
    else {
      freeExports.linkify = linkify;
    }
  }
  else {
